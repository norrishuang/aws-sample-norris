...
public class FlinkCDCPorstgres {
  ...
  public static void main(String[] args) {
    ...
    String strKafkaBostrap =
        "b-1.mskworkshopcluster.hpukmd.c1.kafka.us-east-1.amazonaws.com:9092,b-2.mskworkshopcluster.hpukmd.c1.kafka.us-east-1.amazonaws.com:9092,b-3.mskworkshopcluster.hpukmd.c1.kafka.us-east-1.amazonaws.com:9092";
    String sinkKafkaDDL =
        String.format(
            "CREATE TABLE kafka_pg_portfolio_json (\n"
                + "        id INT,\n"
                + "        reward INT,\n"
                + "        channels STRING,\n"
                + "        difficulty STRING,\n"
    ...
    String transformSQL =
        "INSERT INTO kafka_pg_portfolio_json " + "SELECT * " + "FROM pgsql_source_portfolio";
